...
import { useEditProfileViewModel } from "../viewmodels/edit-profile.viewmodel";
...
export function EditProfilePage() {
  ...
  const {
    ...
    imageUri, showPassword, showConfirmPassword,
    errors, isLoading, apiError,
    setImageUri, setShowPassword, setShowConfirmPassword,
    handleFullNameChange, handleEmailChange,
    handlePasswordChange, handleConfirmPasswordChange, handleSave,
  ...
  const handleSelectImage = async () => {
    ...
    if (!permission.granted) {
      Alert.alert("Permiso requerido", "Debes permitir el acceso a tus fotos para cambiar la imagen.");
      return;
    }
          ...
          <View style={[styles.card, { paddingHorizontal: horizontalPadding, paddingTop: cardPaddingTop }]}>
            <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.formCard}>
                {/* Avatar */}
                <TouchableOpacity style={styles.avatarWrapper} activeOpacity={0.85} onPress={handleSelectImage}>
                ...
                <View style={[styles.inputContainer, errors.password ? styles.inputError : null]}>
                  ...
                  <TouchableOpacity activeOpacity={0.75} onPress={() => setShowPassword(!showPassword)}>
                    <Ionicons name={showPassword ? "eye-outline" : "eye-off-outline"} size={18} color={COLORS.green} />
                  </TouchableOpacity>
                </View>
                ...
                <View style={[styles.inputContainer, errors.confirmPassword ? styles.inputError : null]}>
                  ...
                  <TextInput
                    ...
                    maxLength={30}
                  />
                  <TouchableOpacity activeOpacity={0.75} onPress={() => setShowConfirmPassword(!showConfirmPassword)}>
                    <Ionicons name={showConfirmPassword ? "eye-outline" : "eye-off-outline"} size={18} color={COLORS.green} />
                  </TouchableOpacity>
                </View>
              ...
              >
                {isLoading ? (
                  ...
                  <>
                    <Ionicons name="save-outline" size={15} color={COLORS.background} />
...
const COLORS = {
  ...
  black: "#000000", pink: "#E4568B", error: "#C94C4C",
};
...
const styles = StyleSheet.create({
  ...
  backButton: { position: "absolute", top: 12, left: 18, width: 36, height: 36, borderRadius: 18, justifyContent: "center", alignItems: "center", backgroundColor: COLORS.background },
  ...
  formCard: { width: "100%", borderWidth: 1.4, borderColor: COLORS.green, borderRadius: 14, padding: 22, backgroundColor: COLORS.background, marginBottom: 30 },
  avatarWrapper: { alignSelf: "center", marginBottom: 24 },
  avatarContainer: { backgroundColor: "#D9D9D9", justifyContent: "center", alignItems: "center" },
  avatarImage: { backgroundColor: "#D9D9D9" },
  cameraBadge: { position: "absolute", right: 2, bottom: 2, width: 22, height: 22, borderRadius: 11, backgroundColor: COLORS.background, justifyContent: "center", alignItems: "center", borderWidth: 1, borderColor: COLORS.pink },
  inputContainer: { width: "100%", minHeight: 42, borderWidth: 1, borderColor: COLORS.green, borderRadius: 9, paddingHorizontal: 12, flexDirection: "row", alignItems: "center", marginBottom: 10, backgroundColor: COLORS.background },
  inputError: { borderColor: COLORS.error },
  input: { flex: 1, marginLeft: 8, fontFamily: "MaidenOrange_400Regular", fontSize: 14, lineHeight: 18, color: COLORS.black, paddingVertical: 0 },
  errorText: { fontFamily: "MaidenOrange_400Regular", color: COLORS.error, fontSize: 13, lineHeight: 16, marginTop: -4, marginBottom: 10, marginLeft: 4 },
  saveButton: { alignSelf: "center", flexDirection: "row", backgroundColor: COLORS.pink, paddingHorizontal: 22, paddingVertical: 10, borderRadius: 22 },
  saveButtonText: { fontFamily: "AlfaSlabOne_400Regular", fontSize: 12, lineHeight: 17, color: COLORS.background, marginLeft: 6 },
});